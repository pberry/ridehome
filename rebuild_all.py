...
def rebuild_source_race(db_path, force):
    ...
    The script handles its own skip logic; we just call it unconditionally.
    """
    print("\n" + "=" * 60)
    ...
    try:
        ...
        if force or should_regenerate():
            ...
            mark_as_run()
            print("  ✓ source-race.png: regenerated")
        else:
            print("  source-race.png: skipped (already generated this month)")
    except Exception as e:
        print(f"  ⚠ source-race.png: failed ({e})")
