{% include_relative _includes/wrapped-header.md year="2018" %}
...
| **Friday Longreads Episodes** | 35 Fridays |
| **Total Episodes** | **209 episodes** |
...
| **Weekend Longreads** | 185 | 5.3 links/episode |
| **TOTAL** | **1,202** | - |
...
Topics covered across 1,202 categorized links:
...
**2018 in tech** featured 1,202 curated links across 209 episodes, bringing the most important tech news to listeners.
